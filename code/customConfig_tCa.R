...
getCustomFields <- function() {
                                ...
                                custFields <- c(
(tCa_to_G + tCa_to_T + tGa_to_C + tGa_to_A) / mutations,
tCa_to_G + tCa_to_T + tGa_to_C + tGa_to_A,
(C_to_G + C_to_T + G_to_C + G_to_A) - (tCa_to_G + tCa_to_T + tGa_to_C + tGa_to_A),
tca + tga,
(c + g) - (tca + tga)
                                )

                                testMat <- rbind(c((tCa_to_G + tCa_to_T + tGa_to_C + tGa_to_A), (C_to_G + C_to_T + G_to_C + G_to_A - tCa_to_G - tCa_to_T - tGa_to_C - tGa_to_A)),c(tca+tga, c+g-tca-tga))
...
ft$conf.int[2]
                                ...
                                custFields2 <- c(
((tCa_to_G + tCa_to_T + tGa_to_C + tGa_to_A) * (c + g))/((C_to_G + C_to_T + G_to_C + G_to_A) * (tca + tga)),
((tCa_to_G + tGa_to_C) * (c + g))/((C_to_G + G_to_C) * (tca + tga)),
((tCa_to_T + tGa_to_A) * (c + g))/((C_to_T + G_to_A) * (tca + tga))
                                )
# REMOVE skew decided 10/18/16																
                                #testMat2 <- rbind(c((tCa_to_G + tGa_to_C), (tCa + tGa - tCa_to_G - tGa_to_C)), c((tCa_to_T + tGa_to_A), (tCa + tGa - tCa_to_T - tGa_to_A)))
...
# non-APOBEC_substitutions                             
                                custFields3 <- c(
mutations - tCa_to_G - tCa_to_T - tGa_to_C - tGa_to_A,
substitutions - tCa_to_G - tCa_to_T - tGa_to_C - tGa_to_A)
## EDIT END 1 ##
...
MUTFIELDNAME,
## EDIT START 3 ##
"[(C_to_G)+(C_to_T)]-[(tCa_to_G)+(tCa_to_T)]",
"tca+tga",
"c-tca",
## EDIT END 3 ##
