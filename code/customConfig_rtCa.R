...
# for findMotifs.R
motifs2Find <- c("A", "T", "G", "C", "Cg", "cG", "[ag]tCa", "tGa[ct]", "tCa", "tGa", "tCt", "aGa", "tC", "Ga", "tC[atc]", "[atg]Ga", "cC", "Gg", "[at][ag]C", "G[ct][at]", "Cc", "gG", "[at]A", "T[at]")
findTitles <- c("A", "T", "G", "C", "Cg", "cG", "rtCa", "tGay", "tCa", "tGa", "tCt", "aGa", "tC", "Ga", "tCh", "dGa", "cC", "Gg", "wrC", "Gyw", "Cc", "gG", "wA", "Tw")
#rbind(motifs2Find, findTitles)

# for countMotifs.R
motifs2Count <- c("a", "t", "g", "c", "cg", "[ag]tca", "tga[ct]", "tca", "tga", "tct", "aga", "tc", "ga", "tc[atc]", "[atg]ga", "cc", "gg", "[at][ag]c", "g[ct][at]", "cc", "gg", "[at]a", "t[at]")
countTitles <- c("a", "t", "g", "c", "cg", "rtca", "tgay", "tca", "tga", "tct", "aga", "tc", "ga", "tch", "dga", "cc", "gg", "wrc", "gyw", "cc", "gg", "wa", "tw")
...
getCustomFields <- function() {
                                ...
                                custFields <- c(
(rtCa_to_G + rtCa_to_T + tGay_to_C + tGay_to_A) / mutations,
rtCa_to_G + rtCa_to_T + tGay_to_C + tGay_to_A,
(C_to_G + C_to_T + G_to_C + G_to_A) - (rtCa_to_G + rtCa_to_T + tGay_to_C + tGay_to_A),
rtca + tgay,
(c + g) - (rtca + tgay)
                                )

                                testMat <- rbind(c((rtCa_to_G + rtCa_to_T + tGay_to_C + tGay_to_A), (C_to_G + C_to_T + G_to_C + G_to_A - rtCa_to_G - rtCa_to_T - tGay_to_C - tGay_to_A)),c(rtca+tgay, c+g-rtca-tgay))
...
ft$conf.int[2]
                                ...
                                custFields2 <- c(
((rtCa_to_G + rtCa_to_T + tGay_to_C + tGay_to_A) * (c + g))/((C_to_G + C_to_T + G_to_C + G_to_A) * (rtca + tgay)),
((rtCa_to_G + tGay_to_C) * (c + g))/((C_to_G + G_to_C) * (rtca + tgay)),
((rtCa_to_T + tGay_to_A) * (c + g))/((C_to_T + G_to_A) * (rtca + tgay))
                                )
# REMOVE skew decided 10/18/16																
#                                testMat2 <- rbind(c((rtCa_to_G + tGay_to_C), (rtCa + tGay - rtCa_to_G - tGay_to_C)), c((rtCa_to_T + tGay_to_A), (rtCa + tGay - rtCa_to_T - tGay_to_A)))
...
# non-APOBEC_substitutions                             
                                custFields3 <- c(mutations - rtCa_to_G - rtCa_to_T - tGay_to_C - tGay_to_A, substitutions - rtCa_to_G - rtCa_to_T - tGay_to_C - tGay_to_A)
## EDIT END 1 ##
...
MUTFIELDNAME,
## EDIT START 3 ##
"[(C_to_G)+(C_to_T)]-[(rtCa_to_G)+(rtCa_to_T)]",
"rtca+tgay",
"c-rtca",
## EDIT END 3 ##
